...
```{r supplementary_fig1, fig.width=9, fig.height=4}
...
```{r supplementary_fig2, fig.width=9.6, fig.height=4.5, warning=FALSE, message=FALSE}
...
```{r supplementary_fig3, fig.width=9.2, fig.height=4.6, message=FALSE, warning=FALSE, results='hide', cache=TRUE}
...
```{r supplementary_fig4, fig.width=9.2, fig.height=3.6, warning=FALSE}
