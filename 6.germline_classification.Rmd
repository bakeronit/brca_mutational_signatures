  ...
  partynode(3L, split = sp_d, kids = list(
    partynode(5L, split = sp_e, kids = list(
      partynode(7L, split = sp_b, kids = list(
        partynode(9L, info = "Negative BRCA1/2"),
        partynode(8L, info = "Excluded VUS")
      )),
      partynode(6L, info = "VUS BRCA1/2")
    )),
    partynode(4L, info = "Positive BRCA1/2")
  )),
...
group_labeller <- c("additional_brca1"="VUS BRCA1","additional_brca2"="VUS BRCA2", "exclude"="Exclude","negative_brca1/2"="Negative BRCA1/2", "positive_brca1"="Positive BRCA1", "positive_brca2"="Positive BRCA2")
...
alluvial_labeller <- c("VUS BRCA1/2 ","Exclude","Negative BRCA1/2", "Postive BRCA1", "Positive BRCA2", stringr::str_wrap("Familial Breast", 5),"MAGIC","TCGA-BRCA","Q-IMPROvE", "Yes","No")
