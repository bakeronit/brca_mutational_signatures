...
df2 |> select(c(sample_id, age_group, gender, ER, PR, HER2, tumor_size_category, grade_clean, morphology_clean)) |> rename("Grade"=grade_clean, "Morphology" = morphology_clean, "Tumor size category" = tumor_size_category, "Sample id" = sample_id, "Age Group" = age_group, "Sex" = gender) |> 
...
ggsave("figures/supp-fig5-p2.pdf", p, width = 16, height = 5)
```